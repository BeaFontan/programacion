public class AppDinosaurio {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Temos " + dinosaurio.numDinosaurios + " dinosaurios"); 

        System.out.println("O dinosaurio maior é " + dinosaurio.eMaisVello(din1, din2));
        //como es un método estático, le tendo que poner primero en que clase está y luego llamar al método
